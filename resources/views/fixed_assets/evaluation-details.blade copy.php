        ...
        <div class="card-header">
           <div>
            ...
            <div class="card-options">
               <b>{{$approval_status}}{{$can_edit ? ' ' : 'Evaluation'}}</b>
            </div>
            <div class="card-options">
               <b>{{$approval_status}}</b>
            </div>
            ...
            <div >
                ...
                <table class="table table-vcenter text-center table-striped">
                    ...
                    <tbody>
                            ...
                            <td style="position: relative;   height: 100px; vertical-align: middle; text-align: center;">
                                <div style="position: relative; display: inline-block;">
                                    @if( $notdraft)
                                        <img src="{{ asset('storage/signatures/RUIZ01.png') }}" 
                                            alt="Signature" 
                                            style="display: block; width: 150px; height: auto; z-index: 1; position: relative;" />
                                        <label style="
                                            position: absolute; 
                                            top: 50%; 
                                            left: 50%; 
                                            ...
                                            white-space: nowrap;
                                            font-weight: bold;
                                            pointer-events: none; /* Allows clicking through the text to the image if needed */
                                            color: rgba(0, 0, 0, 0.7); /* Optional: semi-transparent */
                                        ">
                                            {{ $evaluation->draft_date1 ? $user->name : "" }}
                                        </label>
                                        <label>{{ $evaluation->draft_date1 }}</label>
                                    @else
