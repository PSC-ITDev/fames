  ...
  <div class="col-md-12">
    <div class="card">
        ...
        <div id="printArea">
            ...
            <div>
                    <h3>Department: <b>{{$evaluation->department->name}} {{$evaluation->quarter}} {{$evaluation->year}} </b> (<b>{{$asset_count}}</b>) </h3>
...
>>>>>>> Stashed changes
            ...
            <div>
                ...
                <br>
                <table class="table table-vcenter text-center table-sm">
                    <thead>
                        <tr>
                            {{-- <th></th> --}}
