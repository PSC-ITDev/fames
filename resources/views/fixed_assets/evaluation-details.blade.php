      ...
      <form action="{{ route('saveevaluation') }}" method="POST">
        ...
        <div class="card-header">
            <div class="mx-2">
              ...
              <select class="form-select" name="qrt">
                    ...
                    <tbody>
                      @foreach($assets as $index => $asset)
                          ...
                          <tr data-id="{{ $asset->asset->id }}" data-info="{{$asset->asset}}">
                              ...
                              <td class="text-muted"><input type="text" class="form-control" name="remainingAsset[{{$asset->asset->id}}][status]"></td>
                              <td class="text-muted"><input type="text" class="form-control" name="remainingAsset[{{$asset->asset->id}}][action_taken]"></td>
